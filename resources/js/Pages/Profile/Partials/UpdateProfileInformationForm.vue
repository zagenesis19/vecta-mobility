...
import SecondaryButton from '@/Components/SecondaryButton.vue'; // <--- Importado para evitar el warning
...
<template>
    <section> <header>
            ...
            <p class="mt-1 text-sm text-gray-600">
                Actualiza tu nombre de cuenta y dirección de correo electrónico.
            </p>
        </header>
